    ...
    <div class="flex flex-row items-center gap-3 ml-auto md:ml-12">
      ...
      <div class="relative">
        ...
        <ul id="dropdown0" data-type="dropdownmenu" class="[&.show]:!opacity-100 [&.show]:!visible opacity-0 invisible absolute top-[3.1rem] z-30 transition duration-400 ease-in-out left-auto right-0 transform translate-x-1/3 min-w-[150px] inline-flex flex-col py-2 rounded-xl bg-white dark:bg-gray-900 shadow-md dark:shadow-gray-50/10">
          <li class="relative">
            <a href="starter.html#" class="flex flex-row items-center gap-3 py-2.5 px-6 hover-icon hover:bg-surface-200 dark:hover:bg-surfacedark-200">
              <img src="../src/img/flags/US.svg" class="h-4" alt="English">
              English
            </a>
          </li>
          <li class="relative">
            <a href="starter.html#" class="w-full flex flex-row items-center gap-3 py-2.5 px-6 hover-icon hover:bg-surface-200 dark:hover:bg-surfacedark-200">
          ...
          <li class="relative">
            <a href="starter.html#" class="flex flex-row items-center gap-3 py-2.5 px-6 hover-icon hover:bg-surface-200 dark:hover:bg-surfacedark-200">
              <img src="../src/img/flags/SA.svg" class="h-4" alt="Arabic">
              Arabic
            </a>
          </li>
        </ul>
