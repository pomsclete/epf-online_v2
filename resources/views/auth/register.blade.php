...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-gradient-to-r from-red-500 to-purple-500  py-10 px-10">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-5">
                    ...
                    <p class="text-purple-400">Création de compte EPF-ONLINE</p>
                    @if (session('error'))
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <label for="" class="text-xs font-semibold px-1">Prénom & Nom</label>
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('name') border-red-500 @enderror" placeholder="John"
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('email') border-red-500 @enderror" placeholder="johnsmith@example.com"
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                    <input type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('password') border-red-500 @enderror" placeholder="************"
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-12">
                                <label for="" class="text-xs font-semibold px-1">Confirmer mot de passe</label>
                                <div class="flex">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-2">
                                <button type="submit" class="block w-full max-w-xs mx-auto bg-gradient-to-r from-red-500 to-purple-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">OUVRIR UN COMPTE</button>
                                <p class="block w-full max-w-xs mx-auto  text-red rounded-lg px-3 py-3 font-semibold">
                                    Vous avez déja un compte : <a class="text-purple-600" href="{{ route('login') }}">se connecter</a></p>
                            </div>
                        </div>
                    </form>
                </div>
...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Site web epf" href="https://www.epf.africa" target="_blank" class="block w-20 h-20 rounded-full py-2 px-4 bg-white transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <img class="object-cover object-center w-full h-full " src="{{ asset('front/img/logoEpf.png')}}"/>
        </a>
    </div>
</div>
